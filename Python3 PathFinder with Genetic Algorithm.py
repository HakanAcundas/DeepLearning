...
class Traveler():
    def __init__(self, Column = 10, Row = 10, Marked_Zones = 1, Unmarked_Zones = 0, movement_capacity = 20,
                 possible_moves = ["UP","RIGHT","LEFT"], x_Start = 0, y_Start = 0, x_target = 9, y_target = 9):
        ...
        self.Marked_Zones = Marked_Zones
        self.Unmarked_Zones = Unmarked_Zones
        self.Column = Column
        self.Row = Row
        self.map = []
        self.create_map()
